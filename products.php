...
<html>
    ...
    <body>
        <div>
            ...
            <div class="start">
                <div class="title">
                    <h1><center style="color:white"><img src="img/blogo.png" alt="logoname" height="300" class="responsive"> </center></h1>
					</div>
                </div>
            </div>
            <div class="container">
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/women1.png" alt="watch1">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Olive Green Gold Women's Watch</h3>
                                    <p>Price: ₱ 1,699.00</p>
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/women2.png" alt="watch2">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Cherie Paris Black Gold Women's Watch</h3>
                                    <p>Price: ₱ 1,800.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/women3.png" alt="watch3">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Gold MOPGold Women's Watch</h3>
                                    <p>Price: ₱ 2,489.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/women4.png" alt="watch4">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Black Rose Gold Women's Watch</h3>
                                    <p>Price: ₱ 2,489.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/men1.png" alt="watch5">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Aquis Cherry Date Watch</h3>
                                    <p>Price: ₱ 2,300.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/men2.png" alt="Watch6">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Alpine Eagle Men's Watch</h3>
                                    <p>Price: ₱ 1,999.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/men3.png" alt="watch7">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>No. 10600 Men's Watch</h3>
                                    <p>Price: ₱ 2,900.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/men4.png" alt="watch8">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>1966 Automatic Men's Watch</h3>
                                    <p>Price: ₱ 3,000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                ...
                <div class="row">
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/children1.png" alt="watch9">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>VTech Kidizoom Smartwatch DX</h3>
                                    <p>Price: ₱ 1,200.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/children2.png" alt="watch10">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Kids Camouflage LED Sport Watch</h3>
                                    <p>Price: ₱ 900.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/children3.png" alt="watch11">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Timex Time Machines Digital Watch</h3>
                                    <p>Price: ₱ 1,000.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
                    ...
                    <div class="col-md-3 col-sm-6">
                        <div class="thumbnail">
                            <a href="cart.php">
                                <img src="img/children4.png" alt="watch12">
                            </a>
                            <center>
                                <div class="caption">
                                    <h3>Lacoste children's Quartz Watch</h3>
                                    <p>Price: ₱ 1,700.00</p>
                                    <?php if(!isset($_SESSION['email'])){  ?>
                                        <p><a href="login.php" role="button" class="btn btn-primary btn-block">Buy Now</a></p>
                                        <?php
